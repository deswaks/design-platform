...
namespace Vectrosity {
    ...
    public partial class VectorLine {
        ...
        public int layer {
            ...
            set {
                if (gameObject != null) {
                    gameObject.layer = Mathf.Clamp(value, 0, 31);
                }
            }
        }
        [SerializeField]
        ...
        public bool trigger {
            ...
            set {
                ...
                if (gameObject.GetComponent<Collider2D>() != null) {
                    gameObject.GetComponent<Collider2D>().isTrigger = value;
                }
            }
        }
        [SerializeField]
        ...
        public PhysicsMaterial2D physicsMaterial {
            ...
            set {
                ...
                gameObject.GetComponent<Collider2D>().sharedMaterial = value;
            }
        }
        [SerializeField]
        ...
        private void AddColliderIfNeeded() {
            if (gameObject.GetComponent<Collider2D>() == null) {
                gameObject.AddComponent((m_lineType == LineType.Continuous) ? typeof(EdgeCollider2D) : typeof(PolygonCollider2D));
                gameObject.GetComponent<Collider2D>().isTrigger = m_trigger;
                gameObject.GetComponent<Collider2D>().sharedMaterial = m_physicsMaterial;
            }
        }
        ...
        public void SetCanvas(Canvas canvas, bool worldPositionStays) {
            ...
            gameObject.transform.SetParent(canvas.transform, worldPositionStays);
        }
        ...
        public void SetMask(Mask mask, bool worldPositionStays) {
            ...
            gameObject.transform.SetParent(mask.transform, worldPositionStays);
        }
        ...
        private void SetupCanvasState(CanvasState wantedState) {
            if (wantedState == CanvasState.OnCanvas) {
                ...
                if (doSetCanvasParent) {
                    ...
                    gameObject.transform.SetParent(m_canvas.transform, true);
                }
                m_canvasState = CanvasState.OnCanvas;

                if (gameObject.GetComponent<VectorObject3D>() != null) {
                    Object.DestroyImmediate(gameObject.GetComponent<VectorObject3D>());
                    Object.DestroyImmediate(gameObject.GetComponent<MeshFilter>());
                    Object.DestroyImmediate(gameObject.GetComponent<MeshRenderer>());
                }
                if (gameObject.GetComponent<VectorObject2D>() == null) {
                    m_vectorObject = gameObject.AddComponent<VectorObject2D>();
                }
                else {
                    m_vectorObject = gameObject.GetComponent<VectorObject2D>();
                }
            ...
            if (gameObject.GetComponent<VectorObject2D>() != null) {
                Object.DestroyImmediate(gameObject.GetComponent<VectorObject2D>());
                Object.DestroyImmediate(gameObject.GetComponent<CanvasRenderer>());
            }
            m_vectorObject = gameObject.GetComponent<VectorObject3D>();
            if (m_vectorObject == null) {
                m_vectorObject = gameObject.AddComponent<VectorObject3D>();
            }
        ...
        private void SetCollider(bool convertToWorldSpace) {
            ...
            int i = 0;
            if (m_lineType == LineType.Continuous) {
                var collider = gameObject.GetComponent(typeof(EdgeCollider2D)) as EdgeCollider2D;
                ...
                var collider = gameObject.GetComponent(typeof(PolygonCollider2D)) as PolygonCollider2D;
